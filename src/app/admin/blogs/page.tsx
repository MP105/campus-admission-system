...
export default function BlogsPage() {
  ...
  const handleSaveBlog = async () => {
    ...
    // Image URL Validation - Required when editing (not when creating new)
    if (editingBlog && !formData.image?.trim()) {
      validationErrors.push('Blog Image URL is required when editing')
      console.log('❌ Blog Image URL is empty during edit')
    }
    
    // Image URL Validation (if provided, should be valid)
